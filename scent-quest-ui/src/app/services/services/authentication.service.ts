...
export class AuthenticationService extends BaseService {
  ...
  static readonly ResetPassword1Path = '/auth/reset-password-default';
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  resetPassword1$Response(params: ResetPassword1$Params, context?: HttpContext): Observable<StrictHttpResponse<{
}>> {
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  resetPassword1(params: ResetPassword1$Params, context?: HttpContext): Observable<{
}> {
